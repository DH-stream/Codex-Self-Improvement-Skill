...
4. Execute plans with one primary agent by default; use subagents only for independent parallel work or specialist risk that justifies their coordination cost.
...
16. Do not weaken quality gates to optimize tokens.
